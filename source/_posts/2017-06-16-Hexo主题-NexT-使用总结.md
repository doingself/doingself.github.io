...
3. 使用
	...
	![image](2017-06-16-Hexo主题-NexT-使用总结/image.jpg)
	...
	这样的目录结构（目录名和文章名一致），只要使用 `![image](2017-06-16-Hexo主题-NexT-使用总结/image.jpg)` 就可以插入图片。
	...
	`<img src="/2017/06/16/Hexo主题-NexT-使用总结/image.jpg" alt="image">`
